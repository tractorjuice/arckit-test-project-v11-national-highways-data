...
| 2.0 | 2026-04-06 | ArcKit AI | Major update incorporating SRN Initial Report 2025-2030 and Interim Period Delivery Plan 2025-26 external documents. Added 12 new requirements for CAV readiness, decarbonisation, asset lifecycle, NMU data, freight data, iRAP safety, ORR monitoring, EV charging, environmental schemas. Updated network valuation and strategic context. | PENDING | PENDING |

## Document Purpose

This document defines comprehensive business, functional, non-functional, integration, and data requirements for the National Highways Data Architecture Modernization programme. These requirements drive vendor selection, architecture design, testing, and acceptance criteria. Requirements trace back to stakeholder goals (ARC-001-STKE-v1.0) and align with architecture principles (ARC-000-PRIN-v1.0).
...
National Highways manages England's strategic road network (4,500 miles) serving over 4 million customers daily and 45 million daily journeys. The network has a total asset value of £157.4 billion and supports £410 billion GVA from SRN-reliant sectors, with 91% of businesses located within 9 miles of the network. Legacy Oracle databases (10+ years old) and fragmented data silos prevent real-time traffic management, open data publication, and data-driven decision-making. The strategic road network demands modern data architecture to deliver public value through improved journey planning, reduced congestion, and operational efficiency.

The Government's number one mission is economic growth, and National Highways plays a critical role in enabling that growth through reliable, data-driven road infrastructure. Traffic is forecast to grow 27% over 35 years (core scenario), placing increasing demands on the network and the data systems that support it. The Digital Roads strategy (launched September 2021) sets out how technology will fundamentally change the way roads are designed, built, and operated.

National Highways is currently operating within the RIS3 planning context under an interim one-year fiscal settlement (2025-26) with £4.842 billion total investment: £1.4 billion operations, £1.3 billion renewals, £1.3 billion enhancements, £578 million business and digital services, and £89 million designated funds. New smart motorway schemes have been cancelled, requiring the data platform to refocus sensor and operational data strategies away from smart motorway expansion and towards broader Digital Roads capabilities.

This v2.0 update incorporates material from two external strategic documents: the SRN Initial Report 2025-2030 and the Interim Period Delivery Plan 2025-26. These documents expand the scope of the data architecture to address connected and autonomous vehicles, decarbonisation and environmental monitoring, asset lifecycle management, non-motorised user safety, freight and logistics data, iRAP safety ratings, ORR statutory monitoring, and EV charging infrastructure data.
...
- **Data Mesh Architecture**: Implement 5 domain-driven data products (Traffic, Incidents, Roadworks, Assets, Weather) with expansion to support environmental, freight, and safety domains
- **Operational Efficiency**: Reduce incident response time 30% (18 min to 12.6 min) through unified data platform
- **Cost Savings**: Achieve £15M annual operational savings by Year 3 through legacy decommissioning and automation
- **Digital Roads Enablement**: Prepare data platform for connected and autonomous vehicle (CAV) data exchange and V2X communication standards
- **Environmental Accountability**: Support net zero corporate emissions target and decarbonisation tracking across construction, maintenance, and operations
- **Asset Intelligence**: Enable data-driven renewals prioritization and predictive maintenance for £157.4 billion asset base
- **ORR Monitoring**: Automate statutory performance reporting to the Office of Rail and Road
...
- **O-7**: Automated ORR statutory reporting with zero manual data compilation - Supports Goal G-8 (Regulatory Compliance)
- **O-8**: Integrated environmental and carbon data enabling auditable decarbonisation progress tracking - Supports Goal G-9 (Net Zero)
...
- Data mesh architecture with 5+ domain data products (Traffic, Incidents, Roadworks, Assets, Weather) with expansion for environmental, freight, and safety domains
...
- Connected and autonomous vehicle (CAV) data readiness and V2X communication standards
- Decarbonisation and environmental data tracking (carbon emissions, air quality, biodiversity, noise)
- Asset lifecycle data management for £157.4 billion infrastructure asset base
- Non-motorised user (NMU) data services for walkers, wheelers, cyclists, horse riders
- Freight and logistics data services (HGV routing, rest stops, restrictions)
- iRAP safety rating data integration for safety scheme targeting
- ORR statutory performance monitoring and automated reporting
- EV charging network data integration

**Out of Scope**:
- ~~Smart motorway infrastructure upgrades (separate capital programme)~~ Smart motorway new schemes cancelled — legacy smart motorway sensor data migration is in scope
...
- Physical EV charging point installation (separate infrastructure programme)
- CAV vehicle-side systems and hardware (National Highways provides road-side data infrastructure only)
...
| Office of Rail and Road (ORR) | Highways Monitor | Independent Regulator | Performance monitoring | SD-16: Statutory Monitoring |
| Transport Focus | User Satisfaction | Independent Body | Survey oversight | SD-17: Customer Satisfaction |
| Environment Agency | Environmental Regulator | Defra | Environmental compliance | SD-18: Environmental Compliance |
...
**Description**: Deliver real-time traffic data enabling accurate journey planning for over 4 million daily customers and 45 million daily journeys across England's 4,500-mile strategic road network, reducing journey time variability by 20% through improved route information.

**Rationale**: Current 15-minute data delays cause inaccurate journey planning. Real-time data enables drivers to avoid congestion, reducing economic cost of £9B annual congestion impact. Supports Minister's manifesto commitment (SD-1) and public value delivery (SD-13). The SRN supports £410 billion GVA from reliant sectors, and 91% of businesses are within 9 miles of the network, making journey reliability a direct economic growth enabler.
...
**Rationale**: £45M investment requires demonstrable ROI to satisfy CFO (SD-5), Treasury (SD-10), and NAO (SD-14) value for money requirements. Board pressure to reduce operational costs while maintaining service quality. Within the constrained interim one-year settlement (2025-26) of £4.842 billion total investment, demonstrating cost efficiency is paramount for securing future RIS3 investment.
...
- External consultant dependency reduced 50% by Year 2 (45 FTE to 20 FTE)
...
### BR-008: Connected & Autonomous Vehicle (CAV) Data Readiness

**Description**: Prepare the data platform to support future connected and autonomous vehicle (CAV) data exchange requirements, including Vehicle-to-Everything (V2X) communication standards, digital twin road models, and connected road infrastructure data services as defined in the Digital Roads strategy (launched September 2021).

**Rationale**: The Digital Roads strategy sets out how technology will fundamentally change the way roads are designed, built, and operated. Traffic is forecast to grow 27% over 35 years, and CAV technology will be critical to managing increased demand on the 4,500-mile network. The data platform must be architecturally ready to ingest, process, and serve CAV-related data at scale, even though full CAV deployment is a future state. Early architectural readiness avoids costly rework when CAV requirements materialise.

**Success Criteria**:
- V2X data exchange interface specifications defined and documented (aligned with emerging standards: C-ITS, ETSI ITS-G5, C-V2X)
- Digital twin data model supporting high-definition road geometry, lane-level topology, and roadside infrastructure published
- Platform architecture validated for low-latency ( < 100ms) V2X message relay capability
- CAV data product prototype demonstrating sensor-to-vehicle data flow in controlled environment
- Interoperability testing framework established for CAV data exchange with >= 3 industry partners

**Priority**: SHOULD_HAVE

**Stakeholder**: CDTO (SD-3), Transport Minister (SD-1), DfT (Connected Vehicle Programme), Industry Partners

**Traceability**: -> Goal G-8 (Digital Roads) -> Outcome O-7 (CAV data readiness)

---

### BR-009: Decarbonisation & Environmental Data Tracking

**Description**: Enable comprehensive environmental data capture, processing, and reporting to support National Highways' net zero corporate emissions target, 40-50% reduction in construction and maintenance carbon, EV charging network monitoring, air quality tracking, biodiversity net gain measurement, and noise monitoring across the strategic road network.

**Rationale**: National Highways has committed to net zero for corporate emissions and a 40-50% reduction in construction and maintenance carbon. The Interim Period Delivery Plan 2025-26 includes specific monitorable commitments on environmental outcomes. ORR monitors environmental KPIs as part of its statutory oversight. Accurate environmental data is essential for demonstrating progress to regulators, ministers, and the public. The data platform must provide a single source of truth for environmental performance across all operational and capital activities.

**Success Criteria**:
- Corporate carbon emissions tracked in real-time across Scope 1, 2, and 3 categories
- Construction and maintenance carbon calculated per project with automated aggregation
- Air quality monitoring data from roadside sensors integrated and published
- Biodiversity net gain metrics tracked per scheme and aggregated at programme level
- Noise monitoring data correlated with traffic volumes and reported quarterly
- EV charging availability data integrated from charge point operators
- Environmental dashboard providing ORR-ready reporting with drill-down capability
- Automated quarterly environmental performance reports generated for ORR submission

**Priority**: MUST_HAVE

**Stakeholder**: CDTO (SD-3), Environment Agency (SD-18), ORR (SD-16), Transport Minister (SD-1), CFO (SD-5)

**Traceability**: -> Goal G-9 (Net Zero) -> Outcome O-8 (Environmental data tracking)

---

### BR-010: Asset Lifecycle Data Management

**Description**: Implement data-driven asset lifecycle management for National Highways' £157.4 billion infrastructure asset base, enabling renewals prioritization, condition monitoring, predictive maintenance, and lifecycle cost optimization for ageing infrastructure across pavement, structures, technology, geotechnics, drainage, lighting, and tunnels.

**Rationale**: The SRN Initial Report 2025-2030 identifies £1.3 billion annual renewals investment and an ageing asset base requiring increasingly sophisticated data-driven prioritization. Current asset condition data is fragmented across multiple legacy systems with inconsistent schemas, preventing optimal renewals investment decisions. A unified asset data platform enables condition-based maintenance, reducing whole-life costs and improving network reliability. ORR monitors pavement condition as a statutory KPI, requiring accurate and timely asset data.

**Success Criteria**:
- Unified asset register covering all 7 asset categories (pavement, structures, technology, geotechnics, drainage, lighting, tunnels) with >= 95% data completeness
- Asset condition data updated within 48 hours of inspection completion
- Predictive maintenance models consuming asset condition data to forecast renewals needs (3-5 year horizon)
- Lifecycle cost optimization dashboard showing whole-life cost vs. reactive maintenance cost comparison per asset class
- Renewals prioritization algorithm scoring assets by condition, criticality, safety risk, and cost-effectiveness
- ORR pavement condition KPI automated from platform data (no manual compilation)
- Integration with Geographic Information System (GIS) for spatial asset visualization

**Priority**: MUST_HAVE

**Stakeholder**: CDTO (SD-3), COO (SD-6), CFO (SD-5), ORR (SD-16), Asset Domain Owners

**Traceability**: -> Goal G-10 (Asset Intelligence) -> Outcome O-7 (Automated ORR reporting)
...
- End-to-end latency < 2 seconds p95 (sensor reading to platform availability)
...
### FR-009: Non-Motorised User (NMU) Data Services

**Description**: Provide data services supporting the safety and experience of non-motorised users (walkers, wheelers, cyclists, horse riders) affected by the strategic road network, including safety incident data, crossing point locations, active travel route information, and NMU-specific risk assessments.

**User Story**: As an Active Travel Policy Officer, I need consolidated NMU safety and crossing data for the strategic road network so that I can identify high-risk locations and prioritise safety improvements for walkers, wheelers, and cyclists.

**Acceptance Criteria**:
- NMU safety incident data captured and categorized (pedestrian, cyclist, horse rider, wheelchair user) within incident management workflow
- Crossing point inventory published as open data: location, type (bridge, underpass, at-grade), accessibility rating, condition
- NMU risk assessment data linked to road sections with iRAP star ratings (FR-011)
- Active travel route data showing designated paths, cycle facilities, and bridleways adjacent to or crossing the SRN
- API endpoint: `/api/v1/nmu` serving NMU-specific data products (RESTful JSON, GeoJSON)
- Integration with local authority active travel plans for coordinated NMU infrastructure planning
- Annual NMU safety report auto-generated from platform data

**Priority**: SHOULD_HAVE

**Stakeholder**: CDTO (SD-3), Transport Minister (SD-1), Active Travel England, Local Highway Authorities (SD-11)

**Traceability**: -> Goal G-8 (Digital Roads) -> BR-009 (Decarbonisation / active travel)

---

### FR-010: Freight & Logistics Data Services

**Description**: Provide freight-specific data products serving the logistics industry, recognising that the SRN carries two-thirds of all lorry miles in England. Data services include HGV routing optimisation, rest stop and truck stop availability, bridge height and weight restrictions, abnormal load routing, and delivery time window management.

**User Story**: As a Freight Logistics Operator, I need real-time data on HGV-specific restrictions (bridge heights, weight limits, rest stop availability) for the strategic road network so that I can optimise routes, comply with regulations, and reduce costs.

**Acceptance Criteria**:
- HGV-specific routing data published: bridge heights, weight restrictions, width restrictions, hazardous materials routes
- Rest stop and truck stop data: locations, capacity, real-time availability (where sensor-enabled), facilities
- Abnormal load routing data: pre-cleared routes, bridge assessment data, escort requirements
- Delivery time window data: port access schedules, distribution centre approach routes, congestion predictions for freight corridors
- API endpoint: `/api/v1/freight` serving freight-specific data products (RESTful JSON)
- Integration with port operators for freight flow data exchange (Dover, Felixstowe, Southampton corridors)
- Freight corridor performance metrics: average HGV journey times on key routes (M1, M6, M62, A14)

**Priority**: SHOULD_HAVE

**Stakeholder**: CDTO (SD-3), Freight Transport Association, Logistics UK, Port Operators, COO (SD-6)

**Traceability**: -> Goal G-1 (Open Data API) -> BR-003 (Open Data)

---

### FR-011: iRAP Safety Data Integration

**Description**: Integrate International Road Assessment Programme (iRAP) star ratings (1-5 stars) for all segments of the strategic road network, enabling data-driven safety scheme targeting. Currently 19% of the network is rated 1-star or 2-star, representing the highest risk segments requiring prioritised investment.

**User Story**: As a Safety Programme Manager, I need iRAP star ratings integrated with traffic and incident data so that I can identify the highest-risk road segments, prioritise safety investment, and track improvement from 1-2 star to 3+ star ratings over time.

**Acceptance Criteria**:
- iRAP star ratings (1-5) ingested and stored for all SRN segments (4,500 miles)
- Star ratings linked to road section identifiers enabling cross-referencing with incident, traffic, and asset data
- Safety risk scoring combining iRAP rating, incident history, traffic volume, and asset condition
- Dashboard showing network-wide safety profile: percentage of network at each star rating level
- Automated identification of 1-star and 2-star segments with highest killed/seriously injured (KSI) rates
- Historical star rating tracking showing improvement trajectory per segment
- API endpoint: `/api/v1/safety/irap` serving iRAP data products (RESTful JSON, GeoJSON)
- Data refresh: Updated annually aligned with iRAP assessment cycle

**Priority**: MUST_HAVE

**Stakeholder**: CDTO (SD-3), ORR (SD-16), Safety Programme Director, Transport Minister (SD-1)

**Traceability**: -> Goal G-8 (Digital Roads) -> BR-010 (Asset Lifecycle)

---

### FR-012: ORR Performance Dashboard

**Description**: Provide a real-time performance dashboard feeding the Office of Rail and Road (ORR) statutory monitoring function, presenting Key Performance Indicators (KPIs) including killed/seriously injured rates, average delay, pavement condition, biodiversity metrics, user satisfaction, and delivery efficiency, alongside Performance Indicators (PIs) required under the National Highways Licence.

**User Story**: As an ORR Highways Monitor, I need a real-time dashboard with automated KPI feeds so that I can continuously monitor National Highways performance against its licence obligations without relying on manual data submissions.

**Acceptance Criteria**:
- Real-time dashboard presenting all statutory KPIs: killed/seriously injured (KSI), average delay (seconds per vehicle mile), pavement condition (% requiring no further investigation), biodiversity (biodiversity units), user satisfaction (Transport Focus survey scores), delivery efficiency (cost vs. baseline)
- Performance Indicators (PIs) displayed alongside KPIs with trend analysis (monthly, quarterly, annual)
- Automated data feeds from source systems: no manual data compilation for KPI reporting
- Historical trend analysis: minimum 5 years of historical KPI data for trajectory assessment
- Drill-down capability: network-wide to regional to individual road section
- Export functionality: CSV, JSON, and PDF report formats for ORR use
- Data quality indicators displayed per KPI (completeness, freshness, accuracy)
- Dashboard availability: 99.9% uptime with data refresh <= 15 minutes for operational KPIs, daily for survey-based metrics

**Priority**: MUST_HAVE

**Stakeholder**: ORR (SD-16), Transport Focus (SD-17), CDTO (SD-3), COO (SD-6), Transport Minister (SD-1)

**Traceability**: -> Goal G-8 (Digital Roads) -> Outcome O-7 (Automated ORR reporting)
...
- End-to-end latency: < 2 seconds p95 (sensor to platform)
...
**Acceptance Criteria**:
- No network-based implicit trust (private network does not equal trusted)
...
**Description**: Automatically scale API infrastructure to handle 10x traffic spikes (5,000 to 50,000 concurrent requests/second) during major incidents without manual intervention.
...
**Description**: Support 500TB historical data baseline with capacity for 5-year growth (2.5PB total: 500TB x 5 years assuming 5TB/day ingestion).
...
- 5-year growth capacity: 2.5PB (500TB + [5TB/day x 365 days x 5 years])
...
**Description**: Support 10,000 sensors baseline with capacity for 50,000 sensors (5x growth) as Digital Roads and connected infrastructure programmes expand sensor density across the 4,500-mile network.

**Rationale**: Current network: 10,000 sensors. New smart motorway schemes have been cancelled, but Digital Roads strategy drives expansion of connected infrastructure sensors (environmental monitors, EV charging sensors, CAV-enabling infrastructure). Avoid architecture re-work for growth.
...
- Storage limitation: Vehicle registration plates anonymized after 24 hours (automated workflow)
...
#### NFR-C-006: Highways Act & Licence Compliance

**Description**: Ensure the data platform supports compliance with Highways Act 1980 statutory duties, National Highways Licence requirements (issued by the Secretary of State for Transport), and the ORR monitoring framework as Highways Monitor.

**Rationale**: National Highways operates under a statutory licence that sets specific performance requirements monitored by ORR. The Highways Act 1980 places duties on the strategic highway authority regarding maintenance, safety, and public access. The data platform must enable automated evidence collection and reporting against these legal obligations. Non-compliance risks licence enforcement action by ORR and ministerial intervention.

**Acceptance Criteria**:
- All ORR-monitored KPIs and PIs computable from platform data without manual intervention
- Highways Act statutory duty compliance evidence (maintenance standards, safety data, public access) recorded and retrievable
- National Highways Licence conditions mapped to data requirements with automated compliance checks
- ORR Annual Assessment data package auto-generated from platform
- Quarterly ORR engagement data packs produced automatically
- Audit trail demonstrating compliance with licence conditions retained for 7 years
- Escalation alerts triggered when KPI trajectory indicates risk of non-compliance

**Priority**: MUST_HAVE (Legal Requirement)

**Stakeholder**: ORR (SD-16), DfT Perm Sec (SD-2), CDTO (SD-3), COO (SD-6)

**Traceability**: -> BR-010 (Asset Lifecycle) -> FR-012 (ORR Performance Dashboard)
...
**Data Exchange**:
- **National Highways to Emergency Services**: Real-time incident alerts (location, type, severity, estimated impact)
- **Emergency Services to National Highways**: Police traffic management actions, road closures, emergency vehicle routing
...
**Integration Type**: One-way (National Highways to Navigation Apps) via public internet
...
**Data Exchange**:
- **National Highways to Local Authorities**: Strategic road network traffic flow, incidents, roadworks
- **Local Authorities to National Highways**: Local road closures, diversions, traffic conditions
...
**Integration Type**: One-way (Met Office to National Highways) via public internet
...
**Integration Type**: One-time migration (legacy to cloud) with parallel running period
...
### INT-006: Electric Vehicle Charging Network Data

**Description**: Integrate with EV charging point operators to provide real-time charging station availability, location, connector types, and pricing data across the strategic road network, supporting the transition to electric vehicles and National Highways' decarbonisation commitments.

**Integration Type**: One-way (Charge Point Operators to National Highways) via public internet with potential for bi-directional expansion

**Protocol**: OCPI (Open Charge Point Interface) standard, RESTful API (JSON)

**Data Exchange**:
- **Charge Point Operators to National Highways**: Real-time availability (available/occupied/out-of-service), location (GeoJSON), connector types (CCS, CHAdeMO, Type 2), power output (kW), pricing, operator identity
- **National Highways to Public**: Aggregated EV charging data via public API for driver journey planning

**Frequency**: Real-time availability updates (every 5 minutes minimum), static data (location, connector type) updated daily

**Authentication**: OAuth 2.0 client credentials with charge point operators, API key for public consumption

**Acceptance Criteria**:
- Integration with >= 5 major charge point operators covering SRN service areas (Gridserve, bp pulse, Tesla, Osprey, InstaVolt)
- Real-time availability data for >= 80% of SRN-adjacent charging stations
- OCPI v2.2+ compliance for interoperability with charge point operators
- API endpoint: `/api/v1/ev-charging` serving location, availability, connector type, pricing
- EV charging data correlated with journey planning API (show charging options on route)
- Data quality: Availability data freshness < 5 minutes, location accuracy < 50 metres

**Priority**: SHOULD_HAVE

**Stakeholder**: CDTO (SD-3), Transport Minister (SD-1), EV Charging Operators, General Public (SD-13)

---

### INT-007: ORR Statutory Reporting Feed

**Description**: Provide automated data feeds to the Office of Rail and Road (ORR) as Highways Monitor, supporting statutory performance monitoring under the National Highways Licence. Includes automated KPI/PI reporting, Transport Focus survey data integration, and compliance evidence feeds.

**Integration Type**: One-way (National Highways to ORR) via secure API, with Transport Focus survey data ingestion

**Protocol**: RESTful API (JSON), scheduled batch exports (CSV/Excel for legacy ORR systems)

**Data Exchange**:
- **National Highways to ORR**: KPI data (killed/seriously injured, average delay, pavement condition, biodiversity, user satisfaction, delivery efficiency), PI data (network availability, incident clearance times, roadworks overrun rates), compliance evidence, investment delivery progress
- **Transport Focus to National Highways**: Strategic Roads User Survey (SRUS) results, satisfaction scores, qualitative feedback

**Frequency**: Operational KPIs updated daily, survey data ingested quarterly, annual assessment data package generated automatically

**Authentication**: Mutual TLS for ORR API access, secure file transfer for batch exports

**Acceptance Criteria**:
- All statutory KPIs and PIs computable from platform data without manual data compilation
- Automated daily KPI feed to ORR with data quality certification
- Transport Focus SRUS data ingested and correlated with operational metrics
- Annual Assessment data package auto-generated with executive summary, KPI trends, and evidence pack
- Quarterly monitoring reports auto-generated in ORR-specified format
- Data reconciliation: Automated checks ensuring ORR-received data matches National Highways source data
- Feed availability: 99.9% uptime for ORR data feeds

**Priority**: MUST_HAVE

**Stakeholder**: ORR (SD-16), Transport Focus (SD-17), CDTO (SD-3), DfT Perm Sec (SD-2)
...
**Description**: Define standardized schema for traffic flow data from 10,000+ sensors capturing vehicle speeds, volumes, occupancy, and journey times across the 4,500-mile strategic road network.
...
**Data Sources**: Control room operator entries, automated detection (CCTV analytics, sensor anomalies), third-party reports
...
| Environmental/carbon data | OFFICIAL | 10 years | Automated deletion | Decarbonisation reporting, regulatory compliance |
| Asset condition data | OFFICIAL | Lifetime of asset + 7 years | Automated deletion | Asset lifecycle management, legal duties |
| iRAP safety ratings | OFFICIAL | 10 years | Automated deletion | Safety trend analysis, ORR reporting |
| EV charging availability | OFFICIAL | 2 years | Automated deletion | Service quality analysis |
...
### DR-006: Environmental & Carbon Data Schema

**Description**: Define standardized schema for environmental and carbon emissions data, supporting National Highways' net zero corporate emissions target, construction and maintenance carbon reduction (40-50%), biodiversity net gain tracking, air quality monitoring, noise monitoring, and climate resilience data.

**Data Sources**: Corporate emissions reporting systems, construction project carbon calculators, roadside air quality monitors, noise monitoring stations, biodiversity survey data, climate risk assessments, EV charging network data

**Schema Fields - Carbon Emissions**:
- `emission_record_id` (UUID): Unique emission record identifier
- `timestamp` (datetime): Reporting period (ISO 8601)
- `scope` (enum): SCOPE_1 | SCOPE_2 | SCOPE_3
- `category` (string): Emission source category (e.g., "fleet_vehicles", "construction_materials", "electricity")
- `activity` (string): Specific activity (e.g., "asphalt_laying", "office_heating", "concrete_production")
- `project_id` (string): Associated capital project or operational activity reference
- `co2e_tonnes` (float): Carbon dioxide equivalent in metric tonnes
- `calculation_method` (string): Emission factor source and methodology reference
- `data_quality_rating` (enum): MEASURED | CALCULATED | ESTIMATED
- `verified` (boolean): Whether independently verified

**Schema Fields - Air Quality**:
- `monitor_id` (string): Monitoring station identifier
- `timestamp` (datetime): Reading timestamp (ISO 8601 UTC)
- `location` (GeoJSON Point): Geographic coordinates (WGS84)
- `road_id` (string): Adjacent road reference
- `no2_ugm3` (float): Nitrogen dioxide concentration (micrograms per cubic metre)
- `pm25_ugm3` (float): PM2.5 particulate concentration
- `pm10_ugm3` (float): PM10 particulate concentration

**Schema Fields - Biodiversity**:
- `scheme_id` (string): Capital scheme or maintenance activity reference
- `assessment_date` (date): Survey date
- `location` (GeoJSON Polygon): Site boundary
- `baseline_biodiversity_units` (float): Pre-intervention biodiversity units (DEFRA metric)
- `post_intervention_units` (float): Post-intervention biodiversity units
- `net_gain_percent` (float): Percentage net gain achieved
- `habitat_type` (string): Habitat classification

**Schema Fields - Noise**:
- `monitor_id` (string): Noise monitoring station identifier
- `timestamp` (datetime): Reading timestamp (ISO 8601 UTC)
- `location` (GeoJSON Point): Geographic coordinates
- `road_id` (string): Adjacent road reference
- `laeq_16hr_db` (float): Average noise level 0700-2300 (dB LAeq,16h)
- `lnight_db` (float): Average night noise level 2300-0700 (dB Lnight)
- `traffic_volume` (int): Correlated traffic count during measurement period

**Data Quality Rules**:
- Carbon: All Scope 1 and 2 emissions measured or calculated (not estimated); Scope 3 estimated where measurement not feasible
- Air Quality: Readings validated against DEFRA reference methods
- Biodiversity: DEFRA Biodiversity Metric 4.0 methodology applied consistently
- Noise: Measurements compliant with Environmental Noise Directive methodology
- Completeness: >= 95% of monitoring stations reporting per scheduled interval

**Priority**: MUST_HAVE

**Stakeholder**: CDTO (SD-3), Environment Agency (SD-18), ORR (SD-16), CFO (SD-5)

---

### DR-007: Asset Condition Data Schema

**Description**: Define standardized schema for infrastructure asset condition data across all 7 asset categories (pavement, structures, technology, geotechnics, drainage, lighting, tunnels), supporting renewals prioritization, predictive maintenance, and ORR pavement condition KPI reporting for the £157.4 billion asset base.

**Data Sources**: SCANNER survey vehicles (pavement), principal inspections (structures), SCADA systems (technology), bore hole surveys (geotechnics), CCTV drainage surveys, lighting management systems, tunnel condition assessments

**Schema Fields - Common (All Asset Types)**:
- `asset_id` (string): Unique asset identifier (aligned with National Highways Asset Management System)
- `asset_type` (enum): PAVEMENT | STRUCTURE | TECHNOLOGY | GEOTECHNICS | DRAINAGE | LIGHTING | TUNNEL
- `location` (GeoJSON): Geographic location (Point for discrete assets, LineString for linear assets)
- `road_id` (string): Strategic road network reference
- `inspection_date` (date): Date of most recent condition assessment
- `inspector_id` (string): Inspector or survey system identifier
- `overall_condition_score` (float): Normalized condition score (0-100, where 100 = perfect condition)
- `condition_grade` (enum): GOOD | FAIR | POOR | CRITICAL
- `remaining_useful_life_years` (float): Estimated remaining useful life
- `replacement_cost_gbp` (float): Estimated replacement cost (current prices)
- `maintenance_priority_score` (float): Computed priority score combining condition, criticality, safety risk, cost-effectiveness
- `last_renewal_date` (date): Date of most recent renewal intervention
- `next_planned_intervention` (date): Scheduled next intervention date

**Schema Fields - Pavement Specific**:
- `rci_value` (float): Road Condition Indicator value
- `rut_depth_mm` (float): Rut depth in millimetres
- `texture_depth_mm` (float): Surface texture depth
- `skid_resistance` (float): SCRIM coefficient
- `requires_further_investigation` (boolean): ORR KPI flag (pavement condition)

**Schema Fields - Structures Specific**:
- `structure_type` (enum): BRIDGE | RETAINING_WALL | GANTRY | SIGN_STRUCTURE | CULVERT
- `span_metres` (float): Structure span
- `load_capacity_tonnes` (float): Maximum load capacity
- `bci_score` (float): Bridge Condition Index
- `scour_risk` (enum): LOW | MEDIUM | HIGH | CRITICAL

**Data Quality Rules**:
- Condition scores: Validated against inspection methodology standards (DMRB)
- Pavement data: SCANNER survey data calibrated annually
- Structure inspections: Principal inspection data validated by chartered engineer
- Completeness: >= 95% of assets have condition assessment within required inspection cycle
- Timeliness: Condition data uploaded within 48 hours of inspection completion

**Priority**: MUST_HAVE

**Stakeholder**: CDTO (SD-3), Asset Domain Owners, COO (SD-6), ORR (SD-16), CFO (SD-5)
...
### Conflict 5: Innovation Investment vs. Fiscal Constraint

**Conflicting Requirements**:
- **BR-008** (CDTO priority): Digital Roads transformation including CAV data readiness, environmental monitoring, and asset intelligence capabilities requiring significant investment in new data services
- **BR-002** (CFO/Treasury priority): Fiscal prudence within constrained one-year interim settlement (2025-26), with designated funds limited to £89 million for innovation and environment

**Stakeholders Involved**:
- **Innovation**: CDTO (SD-3) wants Digital Roads transformation to position National Highways for CAV future, net zero, and data-driven asset management
- **Constraint**: CFO (SD-5), HM Treasury (SD-10) require fiscal prudence during interim period before RIS3 settlement is confirmed; NAO (SD-14) will scrutinise investment decisions during a period of fiscal uncertainty

**Trade-off Analysis**:
- **Prioritize Innovation**: Invest heavily in BR-008/BR-009/BR-010 capabilities immediately -> Risk: Over-commitment during one-year settlement, Treasury criticism for pre-empting RIS3 spending decisions, potential for stranded investment if RIS3 priorities differ
- **Prioritize Constraint**: Defer all innovation-related requirements to post-RIS3 settlement -> Risk: Loss of Digital Roads momentum, architectural debt accumulates, CAV readiness delayed by 2+ years, environmental monitoring gaps undermine net zero credibility

**Resolution Strategy**: **Foundation-First with Extensible Architecture**
- **Year 1 (Interim Period 2025-26)**: Build foundational data platform architecture that is extensible by design. Implement core requirements (BR-001 to BR-007, all existing FRs, NFRs) using the £578M business/digital services allocation. Use £89M designated funds for:
  - Environmental data schema design and pilot air quality integration (DR-006 foundation)
  - Asset condition data unification pilot across 2 asset categories (DR-007 foundation)
  - ORR automated reporting feed (INT-007) — delivers immediate regulatory compliance value
  - CAV data exchange specification development (BR-008 design only, not build)
- **Year 2+ (Post-RIS3 Settlement)**: Scale innovation capabilities based on confirmed RIS3 funding:
  - Full CAV data platform build-out (BR-008 implementation)
  - Comprehensive environmental monitoring network (BR-009 full scope)
  - All 7 asset categories unified with predictive maintenance (BR-010 full scope)
  - NMU and freight data services (FR-009, FR-010)

**Decision Authority**: RACI Matrix -> Investment Committee (CFO Chair, CDTO, DfT Finance Director) reviews innovation spend quarterly against designated funds allocation

**Outcome**:
- **CDTO "wins"**: Platform architecture is extensible for Digital Roads vision; key specifications and pilots advance readiness
- **CFO "wins"**: Innovation spending contained within designated funds (£89M); no over-commitment during interim period
- **Treasury "wins"**: Fiscal prudence demonstrated; investment decisions reversible if RIS3 priorities change
- **Resolution**: Innovation roadmap aligned to RIS3 planning cycle; interim period delivers foundations and specifications while avoiding premature large-scale commitment
...
| BR-008 | CAV Data Readiness | SD-3 (CDTO), SD-1 (Minister) | G-8 | O-7 (CAV readiness) | #1 Real-Time First | SHOULD |
| BR-009 | Decarbonisation & Environmental Tracking | SD-3 (CDTO), SD-18 (Environment) | G-9 | O-8 (Environmental tracking) | #8 Data Mesh | MUST |
| BR-010 | Asset Lifecycle Data Management | SD-3 (CDTO), SD-16 (ORR) | G-10 | O-7 (ORR reporting) | #8 Data Mesh | MUST |
...
| FR-009 | NMU Data Services | SD-3 (CDTO), SD-1 (Minister) | G-8 | O-8 (Safety data) | #5 Open by Default | SHOULD |
| FR-010 | Freight & Logistics Data | SD-3 (CDTO), SD-6 (COO) | G-1 | O-5 (API adoption) | #5 Open by Default | SHOULD |
| FR-011 | iRAP Safety Data Integration | SD-3 (CDTO), SD-16 (ORR) | G-8 | O-7 (Safety targeting) | #8 Data Mesh | MUST |
| FR-012 | ORR Performance Dashboard | SD-16 (ORR), SD-17 (Transport Focus) | G-8 | O-7 (ORR reporting) | #7 Observability | MUST |
...
| NFR-C-006 | Highways Act & Licence Compliance | SD-16 (ORR), SD-2 (DfT) | G-8 | O-7 (ORR reporting) | N/A | MUST |
...
| INT-006 | EV Charging Network Data | SD-3 (CDTO), SD-13 (Public) | G-9 | O-8 (Environmental tracking) | #6 Interoperability | SHOULD |
| INT-007 | ORR Statutory Reporting Feed | SD-16 (ORR), SD-17 (Transport Focus) | G-8 | O-7 (ORR reporting) | #6 Interoperability | MUST |
...
| DR-006 | Environmental & Carbon Data Schema | SD-3 (CDTO), SD-18 (Environment) | G-9 | O-8 (Environmental tracking) | #8 Data Mesh | MUST |
| DR-007 | Asset Condition Data Schema | SD-3 (CDTO), SD-16 (ORR) | G-10 | O-7 (ORR reporting) | #8 Data Mesh | MUST |
...
- **BCI**: Bridge Condition Index - Standardised metric for assessing bridge structural condition
...
- **C-ITS**: Cooperative Intelligent Transport Systems - Standards for vehicle-to-infrastructure communication
- **CNI**: Critical National Infrastructure - Assets essential to national security and economy
- **C-V2X**: Cellular Vehicle-to-Everything - Cellular-based V2X communication technology
- **DATEX II**: European standard for traffic and travel information exchange
- **DEFRA**: Department for Environment, Food and Rural Affairs
- **DMRB**: Design Manual for Roads and Bridges - Technical standards for UK road infrastructure
...
- **GVA**: Gross Value Added - Measure of economic output
- **iRAP**: International Road Assessment Programme - Global road safety assessment methodology
- **ITHC**: IT Health Check - UK Government security assessment for OFFICIAL-SENSITIVE systems
- **KSI**: Killed or Seriously Injured - Road safety metric
...
- **NMU**: Non-Motorised User - Walkers, wheelers, cyclists, horse riders
- **OCPI**: Open Charge Point Interface - Standard protocol for EV charging data exchange
- **OpenAPI**: Industry standard specification for RESTful APIs
- **ORR**: Office of Rail and Road - Independent regulator and Highways Monitor
- **PSN**: Public Services Network - Secure government network for inter-agency data exchange
- **RCI**: Road Condition Indicator - Composite measure of road surface condition
- **RIS3**: Third Road Investment Strategy - Government investment plan for strategic roads (2025-2030)
...
- **SCANNER**: Surface Condition Assessment for the National Network of Roads - Pavement survey method
- **SCRIM**: Sideway-force Coefficient Routine Investigation Machine - Skid resistance measurement
- **SIEM**: Security Information and Event Management - Centralized security monitoring
- **SRN**: Strategic Road Network - England's motorways and major A-roads managed by National Highways
- **SRUS**: Strategic Roads User Survey - Transport Focus user satisfaction survey
...
**Generation Context**: Updated from ARC-001-STKE-v1.0, ARC-000-PRIN-v1.0, ARC-001-RISK-v1.0, plus new external documents: SRN Initial Report 2025-2030 and Interim Period Delivery Plan 2025-26
