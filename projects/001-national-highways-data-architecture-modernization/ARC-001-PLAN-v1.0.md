...
| **Reviewed By** | PENDING |
| **Approved By** | PENDING |
| **Distribution** | Programme Team, Steering Committee, Executive Board |
...
|-------------|-------|----------|
| ARC-001-STKE-v1.1 | Stakeholder Drivers & Goals | `stakeholder-drivers.md` |
| ARC-001-REQ-v1.1 | Requirements | `requirements.md` |
| ARC-001-RISK-v1.1 | Risk Register | `risk-register.md` |
| ARC-001-DATA-v1.1 | Data Model | `data-model.md` |
| ARC-001-WARD-v1.0 | Wardley Map | `wardley-maps/procurement-strategy.md` |
| ARC-001-TCOP-v1.1 | TCoP Assessment | `tcop-assessment.md` |
| ARC-001-SBD-v1.1 | Secure by Design Assessment | `ukgov-secure-by-design.md` |
| ARC-NH-PRIN-v1.1 | Architecture Principles | `.arckit/memory/architecture-principles.md` |
