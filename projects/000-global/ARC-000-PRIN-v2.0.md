...
> **Template Origin**: Official | **ArcKit Version**: 4.6.3 | **Command**: `/arckit:principles`
...
| **Project** | National Highways Data Architecture Modernization (Project 000 - Global) |
...
| **Reviewed By** | PENDING |
| **Approved By** | PENDING |
| **Distribution** | All Technology Teams, Architecture Review Board, Project Delivery Teams |

## Revision History

| Version | Date | Author | Changes | Approved By | Approval Date |
|---------|------|--------|---------|-------------|---------------|
| 1.0 | 2025-11-13 | ArcKit AI | Initial creation from `/arckit.principles` command | PENDING | PENDING |
| 1.1 | 2026-01-26 | ArcKit AI | Updated to v0.11.2 template format | PENDING | PENDING |
| 2.0 | 2026-04-06 | ArcKit AI | Major update incorporating SRN Initial Report 2025-2030 and Interim Period Delivery Plan 2025-26 external documents. Added 3 new principles: Connected Roads & CAV Data Readiness (#23), Asset Intelligence & Lifecycle Data Management (#24), Regulatory Transparency & Statutory Reporting (#25). Updated Principle #2 network length, expanded Principle #6 integration standards, expanded Principle #8 data mesh domains, strengthened Principle #18 sustainability targets. | PENDING | PENDING |
...
National Highways is responsible for operating, maintaining, and improving England's strategic road network (SRN) — a £157.4 billion asset base comprising 4,500 miles of motorways and major A-roads. Most motorways were built in the 1960s and 1970s and now require growing renewals investment. The Digital Roads strategy (launched September 2021) sets out how technology will fundamentally change the way roads are designed, built, operated, and used. As we enter the third road period (RIS3), the data architecture must support connected and autonomous vehicle readiness, evidence-based asset management, and automated statutory reporting to the Office of Rail and Road (ORR) as Highways Monitor.
...
- **ORR Monitoring**: Statutory performance monitoring (KPIs, PIs, monitorable commitments)
...
**Principle Statement**:
All systems MUST scale horizontally to serve England's 4,500-mile strategic road network with capacity for 10x traffic growth during major incidents or severe weather.
...
- **Connected & Autonomous Vehicles**: V2X infrastructure, C-ITS stations
...
- **C-ITS**: Cooperative Intelligent Transport Systems messaging
- **OCPI**: Open Charge Point Interface for EV charging data
...
### 23. Connected Roads & Autonomous Vehicle Data Readiness

**Principle Statement**:
All data architectures MUST be designed to support the future exchange of data with connected and autonomous vehicles (CAVs), cooperative intelligent transport systems (C-ITS), and smart road infrastructure. Platform data models and APIs MUST be extensible to accommodate V2X (vehicle-to-everything) communication standards as they mature.

**Rationale**:
The Digital Roads strategy (launched September 2021) sets out how technology will fundamentally change the way roads are designed, built, operated, and used. Connected and autonomous vehicles, personalised journey information, and V2X communication represent the future of road infrastructure. While full CAV deployment is beyond the current programme scope, the data platform must not create architectural barriers to future integration. The SRN Initial Report identifies connected roads and autonomous vehicles as key areas where technology offers safer, more reliable, and more sustainable journeys.

**Implications**:
- Data models must include extensible schemas for V2X message types
- APIs must support low-latency bidirectional communication patterns for real-time vehicle interaction
- Geospatial data precision must support lane-level accuracy (not just road-level)
- Event streaming infrastructure must accommodate high-frequency vehicle telemetry at scale
- Standards-based approach: design to emerging C-ITS and ETSI standards where available
- Digital twin capability: road network digital representation supporting simulation and CAV testing

**Validation Gates**:
- [ ] Data models reviewed for CAV extensibility (no hard-coded assumptions blocking future V2X data)
- [ ] API design supports bidirectional real-time patterns (not request/response only)
- [ ] Geospatial data supports lane-level precision where available
- [ ] Event streaming capacity plans account for future vehicle telemetry volumes
- [ ] C-ITS and ETSI standards referenced in integration architecture
- [ ] Digital Roads strategy alignment confirmed at architecture review

**Common Violations to Avoid**:
- Hard-coded data models that cannot accommodate new V2X message types
- Road-level-only geospatial precision blocking lane-level navigation
- Synchronous-only API patterns that cannot support real-time vehicle communication
- Ignoring emerging C-ITS standards in favour of proprietary protocols

**Priority**: SHOULD_HAVE (future-readiness, not current delivery)
...
- **Environmental Domain**: Carbon emissions, biodiversity, air quality, noise, climate resilience data
- **Freight Domain**: HGV routing, rest stops, weight restrictions, logistics data
- **Safety Domain**: iRAP ratings, KSI statistics, safety scheme targeting
...
### 24. Asset Intelligence & Lifecycle Data Management

**Principle Statement**:
All physical infrastructure assets on the strategic road network MUST have a digital representation in the data platform with condition data, maintenance history, and lifecycle cost information. Asset data MUST support evidence-based renewals prioritization and predictive maintenance.

**Rationale**:
The SRN has a total asset value of £157.4 billion. Most motorways were built in the 1960s and 1970s and now require growing renewals investment. The Interim Delivery Plan allocates £1.3 billion for renewals in 2025-26. The SRN Initial Report identifies ageing infrastructure as an increasingly important challenge requiring data-driven asset management. Technology assets (CCTV, signs, signals, Stopped Vehicle Detection) have become central to network operation and require condition monitoring. National Highways' approach to asset management (published May 2022) requires mature asset data capabilities.

**Asset Categories** (from Interim Delivery Plan):
- **Pavement**: Road surfaces (flexible asphalt, rigid concrete) — KPI: 96.2% in good condition
- **Structures**: Bridges, tunnels, retaining walls, gantries
- **Technology**: CCTV, signs, signals, Stopped Vehicle Detection — PI: Technology availability
- **Geotechnics**: Earthworks, cuttings, embankments
- **Drainage**: Culverts, gullies, pipes, outfalls
- **Lighting**: Road lighting, sign lighting, LED upgrades
- **Road Restraints**: Safety barriers, central reservation barriers

**Implications**:
- Asset register must be comprehensive (every physical asset has a digital record)
- Condition data must be current (inspection schedules, sensor monitoring)
- Maintenance history must be linked to assets (work orders, costs, dates)
- Lifecycle cost models must be calculable from asset data
- Renewals prioritization must be data-driven (worst-first with risk weighting)
- ORR performance reporting must be automated (pavement condition KPI, structures condition PI)

**Validation Gates**:
- [ ] Asset register comprehensive for all 7 asset categories
- [ ] Condition data current (within inspection schedule tolerances)
- [ ] Maintenance history linked to asset records
- [ ] Lifecycle cost models available for major asset categories
- [ ] Renewals prioritization algorithm uses asset condition data
- [ ] ORR performance indicators automated (pavement condition, structures, technology availability)

**Common Violations to Avoid**:
- Paper-based or spreadsheet asset registers not integrated with data platform
- Condition data siloed in separate systems without API access
- Renewals prioritized by region or politics rather than asset condition evidence
- Technology assets (digital infrastructure) excluded from asset management
...
**Rationale**:
UK Government has net-zero carbon commitment by 2050. Data centers and cloud infrastructure consume significant energy. Sustainable design reduces operational costs and environmental impact. National Highways has committed to net zero corporate emissions and a 40-50% reduction in carbon from construction and maintenance over RIS3. The Interim Period Delivery Plan 2025-26 includes biodiversity and carbon emissions as monitored KPIs.
...
**Carbon Targets**:
- **Construction & Maintenance Carbon**: 40-50% reduction target over RIS3 period
- **Corporate Carbon**: Net zero target (68% reduction achieved against 2017-18 baseline)
...
- [ ] Environmental KPIs automated for ORR statutory reporting (biodiversity, carbon, air quality, noise)
...
### 25. Regulatory Transparency & Statutory Reporting

**Principle Statement**:
All data products and systems MUST support automated, auditable statutory reporting to the Office of Rail and Road (ORR) and other regulatory bodies. Performance data MUST be generated from operational systems (not manual compilation) to ensure accuracy and timeliness.

**Rationale**:
The ORR, in its statutory role as Highways Monitor, holds National Highways to account against monitorable commitments, the Licence, and DfT Statutory Directions and Guidance. The Interim Delivery Plan 2025-26 defines KPIs (killed/seriously injured, average delay, pavement condition, biodiversity, user satisfaction, delivery efficiency) and PIs (journey time reliability, technology availability, noise, carbon, ride quality, iRAP star rating) that require automated data feeds. Manual reporting is error-prone, slow, and does not enable real-time performance visibility.

**Statutory Reporting Requirements**:
- **KPIs**: Killed/seriously injured, average delay, pavement condition, biodiversity, user satisfaction, delivery efficiency
- **PIs**: Journey time reliability, technology availability, maintenance/construction carbon, ride quality, iRAP star rating, noise, air quality, delay from roadworks, structures condition
- **Capital specification**: Renewals delivery (lane-km asphalt, concrete reconstruction), enhancement schemes progress
- **Designated funds**: Innovation, environment, and safety investment tracking

**Implications**:
- Performance data must flow directly from operational systems to reporting dashboards
- No manual data re-keying or spreadsheet compilation for statutory reports
- Data lineage must be transparent (ORR can trace any reported figure to source data)
- Historical performance data must be retained for trend analysis across road periods
- Consistency with previous road period metrics where possible (enable comparison)
- Transport Focus survey data must be integrated for user satisfaction reporting

**Validation Gates**:
- [ ] All statutory KPIs and PIs automated from source operational data
- [ ] Data lineage documented from source system to reported figure
- [ ] Historical performance data retained for cross-road-period comparison
- [ ] Reporting dashboards accessible to ORR for independent monitoring
- [ ] No manual data compilation steps in statutory reporting pipeline
- [ ] Audit trail for any manual adjustments or corrections to reported data

**Common Violations to Avoid**:
- Manual spreadsheet compilation of statutory performance data
- Reporting figures that cannot be traced to source operational data
- Different figures reported to ORR versus used internally (dual reporting)
- Performance data only available retrospectively (no real-time visibility)
...
| 23 | Connected Roads & CAV Data Readiness | Strategic | SHOULD_HAVE | CAV extensibility review, C-ITS standards referenced |
| 24 | Asset Intelligence & Lifecycle Data Management | Data | HIGH | Asset register comprehensive, ORR PIs automated |
| 25 | Regulatory Transparency & Statutory Reporting | Quality | HIGH | Statutory KPIs/PIs automated, data lineage documented |
...
- **CAV**: Connected and Autonomous Vehicle - vehicles with automated driving and V2X communication capabilities
- **C-ITS**: Cooperative Intelligent Transport Systems - systems enabling vehicles and infrastructure to share information
- **C-V2X**: Cellular Vehicle-to-Everything - cellular-based V2X communication technology (3GPP standard)
...
- **ETSI**: European Telecommunications Standards Institute - develops C-ITS and V2X communication standards
- **GeoJSON**: Standard format for geospatial data
- **GVA**: Gross Value Added - measure of economic contribution used in Green Book business cases
- **iRAP**: International Road Assessment Programme - star rating system for road safety
- **ITHC**: IT Health Check (UK Government security assessment)
- **KSI**: Killed or Seriously Injured - key road safety metric monitored by ORR
- **NCSC**: National Cyber Security Centre (UK)
- **NMU**: Non-Motorised User - pedestrians, cyclists, equestrians using or crossing the SRN
- **OCPI**: Open Charge Point Interface - protocol for EV charging data exchange
...
- **ORR**: Office of Rail and Road - statutory Highways Monitor holding National Highways to account
- **RIS3**: Road Investment Strategy 3 - the third road period strategic plan (2025-2030)
...
- **V2X**: Vehicle-to-Everything - communication between vehicles and infrastructure, other vehicles, pedestrians, and networks
...
- SRN Initial Report 2025-2030 - Strategic plan for the third road period
- Interim Period Delivery Plan 2025-26 - One-year delivery plan with monitorable commitments
- Digital Roads strategy (September 2021) - Technology transformation vision
- National Highways approach to asset management (May 2022) - Asset data capabilities
...
- [ETSI C-ITS Standards](https://www.etsi.org/technologies/cooperative-its) - Cooperative Intelligent Transport Systems
...
**Project**: National Highways (Global - Project 000)
**AI Model**: claude-opus-4-6
**Generation Context**: Updated from existing ARC-000-PRIN-v1.0 incorporating SRN Initial Report 2025-2030 and Interim Period Delivery Plan 2025-26 external documents
